# ==========================================================
# app/chatbot.py — WorkFriend Chatbot (v2.0 — Controls Above the Fold)
# ==========================================================
 
import gradio as gr
...
    #
======================================================
    # 🎨 Unified Button Styling & CHATBOT HEIGHT FIX (UPDATED)
    #
======================================================
    custom_css = """
    /* --- CHATBOT HEIGHT OVERRIDE (New Section) --- */
    /* 🎯 Targets the component wrapper */
    .chatbot-area {
        max-height: 300px !important; /* Force the component to be smaller */
        overflow: hidden !important;
        padding: 0 !important;
    }
    
    /* 🎯 Targets the internal Gradio component div (the scrolling part) */
    .chatbot-area > div:not(.gr-label) {
        max-height: 300px !important;
        min-height: 300px !important; /* Lock the size */
        overflow: auto !important;
    }

    /* --- Button Styling (From v1.9) --- */
...
 
        # 🎯 Apply the new class for height override
        chatbot = gr.Chatbot(
                label="WorkFriend Conversation",
                type="messages",
                height=420,
                elem_classes=["chatbot-area"] # <--- NEW
            )
...
        send_btn.click(fn=answer_fn, inputs=[user_input, chatbot], outputs=chatbot)
        ...
        # --- JS injection to handle copy (UNCHANGED) ---
        gr.HTML(
           """
           <script>
           setTimeout(() => {
