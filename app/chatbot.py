...
# ✅ Adds visible thumbs-up / thumbs-down feedback toggle
# ==========================================================
...
def add_feedback_actions():
    """Creates visible thumbs-up/down buttons with colour toggle."""
...
def add_user_actions(chatbot, retrieve_fn):
    ...
    # 👇 build feedback row *after* other buttons so it’s visible
